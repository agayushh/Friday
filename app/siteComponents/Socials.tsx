...
const Socials = () => {
  return (
    <div className="mt-10 overflow-hidden grid grid-cols-1 sm:grid-cols-2">
      {SOCIAL_LINKS.map((social, index) => (
        <div
          key={index}
          className="flex items-center justify-between group p-4 hover:bg-gray-50 dark:hover:bg-[#111] transition-colors"
        >
